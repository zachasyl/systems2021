...
int main(){
    ...
    // 	// Our first argument is the program we want to launch.
     		myargv[1]="-F";		
    // 		// Any additional arguments (i.e. flags) we want to make use of.
     			myargv[2]=NULL; 	
    // 			// Terminate the argument list--similar to how we would terminate a character string.
    ...
    // 								// Note: There are other 'exec' functions that may be helpful.
						...
						printf("Child: Should never get here\n");
														exit(1);
     																	...
     																	wait(NULL); 
    // 																	        // handy synchronization function again!
